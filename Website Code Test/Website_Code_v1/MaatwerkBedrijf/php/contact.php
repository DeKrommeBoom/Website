...
$from = 'Website Maatwerkbedrijf KrommeBoom';

// an email address that will receive the email with the output of the form
$sendTo = 'dekrommeboom@telenet.be';

// subject of the email
$subject = 'Nieuw bericht van website contacteer ons ';
...
$goto_after_mail = "http://localhost/website/MaatwerkBedrijf/testdemo.html";
...
try
{
    ...
    $emailText = "Nieuw bericht van contact pagina maatwerkbedrijf\n=============================\n";
